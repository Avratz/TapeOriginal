<?php /* Template Name: Page Centros de Kinesiología */ get_header(); ?>

<div class="container min-h">
	<div class="row">
		<h3 class="py-2"><i class="fas fa-building"></i>    Centros de Kinesiología</h3>
		<?php
				$row = 0;
				$args = array( 'post_type' => 'centros_de_kine', 'posts_per_page' => 12 );
